...
//now we count how many days
    ...
    $expire_days  ="Expired" ; 
        ...
        $sql = "UPDATE `purchase` SET `purchase_id`='$id',`supplier_name`='$supplier_name',
        `payment_type`='$payment_mode',`medicine_name`='$med_name',`generic_name`='$generic_name',`packing`='$packing',
        `batch_id`='$batch_id',`quantity`='$quantity',`mrp`='$mrp',`amount`='$amount',`expired_date`='$expire_date',
        `present_date`='$current_date',`medicine_condition`='$expire_days',`purchase_date`=now() WHERE `purchase_id`='$id' ";
    ...
    <?php
        ...
        <div class="row">
            ...
            <div class="col-md-12" style="border-radius:10px; border-bottom:2px solid orangered"><br>
                 <h4>Update Medicine Purchased</h4>
                 <p style="margin-left:50px;margin-bottom:20px;"> Update Purchase</h>
                       ...
                       <div class="row">
                        <div class="col-md-6">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <option selected><?php echo $rows['supplier_name']?></option>
                        ...
                        <div class="col-md-6">
                                <div class="form-group mb-2">
                                    ...
                                    <select name="payment_mode" id="" class="form-control" >
                                        <option selected><?php echo $rows['payment_type']?></option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group mb-2">
                                                ...
                                                <input type="text" name="med_name" class="form-control"  value="<?php echo $rows['medicine_name']?>">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group mb-2">
                                                <label for="">Generic Name: </label>
                                                <input type="text" name="generic_name" class="form-control" value="<?php echo $rows['generic_name']?>"  Required>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group mb-2">
                                                <label for="">Packing:</label>
                                                <input type="text" name="packing" class="form-control" value="<?php echo $rows['packing']?>" Required>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group mb-2">
                                                <label for="">Batch-ID</label>
                                                <input type="text" name="batch_id" class="form-control" value="<?php echo $rows['batch_id']?>" Required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group mb-2">
                                                ...
                                                <input type="date" name="expire_date" class="form-control" value="<?php echo $rows['expired_date']?>"  Required>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group mb-2">
                                                <label for="">Current Date: </label>
                                                <input type="date" name="current_date" class="form-control" value="<?php echo $rows['present_date']?>" Required>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group mb-2">
                                                <label for="">Quantity:</label>
                                                <input type="text" name="quantity" class="form-control" id="quantity" onkeyup="cal_quantity(this.value);"  value="<?php echo $rows['quantity']?>"required>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group mb-2">
                                                <label for="">MRP:</label>
                                                <input type="text" name="mrp" class="form-control" id="mrp" onkeyup="cal_mrp(this.value)"  value="<?php echo $rows['mrp']?>" Required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group mb-2">
                                                ...
                                                <input type="text" name="amount" class="form-control" id="amount" value="<?php echo $rows['amount']?>" disabled>
                                            </div>
                                        </div><br>
                                    </div><br>

                                    <button name="purchase" class="btn btn-primary" style="color:white; margin-bottom:30px">Update Purchase</button>
                                </div><br><br>
