            ...
            <div class="col-md-4">
                <a href="" style="text-decoration:none">
                    <!-- <div class="card-header" style="border-radius:30px">
                        <h4 style="text-align:center; color:white">Expired Drugs</h4>
                    </div> -->
                </a>
    ...
    <div class="container-fluid"><br>
        <div class="row">
            ...
            <div class="col-md-12" style="border-radius:10px; border-bottom:2px solid orangered"><br><br>
                 ...
                 <p style="margin-left:50px;margin-bottom:20px;">Recorded Drugs Expired</h>
                 <h2 style="border-bottom:2px solid orangered;"></h2><br><br>
        ...
        <div class="row">
                    ...
                    <tbody id="table-body" class=" table" style="color:navy; font-size: 16px; text-align: justify;">
                        ...
                        <?php
                            ...
                            ?>
                                ...
                                <td ><?php echo $row['drug_condition']?></td>   
                                </tr>
            ...
            <div class="row">
                <div class="col-md-1"></div>
                <div class="col">
                    <form action="print_expired_drugs.php" method="post">
                        <div class="container">
                        <div class="row">
