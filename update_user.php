...
if(isset($_POST['update_user'])){
    ...
    if($password != $confirm_password){  
        ...
        header("Location: update_user.php?msg=Password Do Not Match!!!.");
        exit(0);
    ...
    if(strlen(($password) < 4)){
        ...
        header("Location: update_user.php?msg=Password Must Be a Maximum of 4 Characters. ");
        exit(0);
    }
    ...
    $bcrypt_password = password_hash($password, PASSWORD_BCRYPT);
        ...
        $sql = "UPDATE `users` SET `user_id`='$id',`fname`='$fname',`lname`='$lname',`email`='$email',`password`='$bcrypt_password',`date`=now() WHERE `user_id`='$id'";
        $query = mysqli_query($conn,$sql);
    
    if($query){
        $_SESSION['message'] = "New User Record Updated Successfully" . mysqli_error($conn);
        header("Location: manage_user.php?msg=New User Record Updated Successfully.");
        exit(0);
    } 
    else{
        $_SESSION['message'] = "User Record Not Successfully Updated" . mysqli_error($conn);
        header("Location: update_user.php?msg=User Record Not Successfully Updated. ");
        exit(0);
    }
}
        ...
        <div class="row">
            ...
            <div class="col-md-12" style="border-radius:10px; border-bottom:2px solid orangered"><br><br>
                 ...
                 <form action="" method="post">
                       ...
                       <button name="update_user" class="btn btn-primary" style="color:white">Update User</button><br><br>
