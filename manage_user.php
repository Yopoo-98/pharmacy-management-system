    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <a href="add_user.php" style="text-decoration:none">
                <div>
                    <h4 style="color:#A52A2A;font-weight:bolder">Add User</h4>
                </div>
                </a>
            </div>
            <div class="col-md-4">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12" style="border-radius:10px; border-bottom:2px solid orangered"><br>
                 <h4>Manage Users</h4>
                 <p style="margin-left:50px;margin-bottom:20px;">Manage Existing Users</h>
                                ...
                                <tbody id="datatableid" class=" table table-responsive table-striped bg-info table-hover" style="color:navy; font-size: 16px; text-align: justify;">
                                    ...
                                    <?php
                                        ...
                                        ?>
                                            ...
                                            <td>
                                                <a href="update_user.php?update_id=<?php echo $row['user_id']?>" id="update" style="color:green;"><i class="fa-solid fa-pen-to-square"></i></a>
                                                <a onclick="return confirm('Do You Really Want to Delete This Record? ')" href="delete_user.php?delete_id=<?php echo $row['user_id']?>" id="delete" style="color:red;"><i class="fa-solid fa-trash"></i></a> 
                                            </td>
