...
<head>
    ...
    <title>Monitor Medicine Expiry</title>
                                    ...
                                    <tbody id="datatableid" class="table table-responsive table-striped bg-info table-hover" style="color:navy; font-size: 16px; text-align: justify;">
                                        ...
                                        <?php
                                            ...
                                            ?>
                                                ...
                                                <td>
                                                <a href="update_monitor_expiry.php?update_id=<?php echo $row['medicine_id']?>" id="update" style="color:green;"><i class="fa-solid fa-pen-to-square"></i></a>
                                                    <a onclick="return confirm('Do You Really Want to Delete This Record? ')" href="delete_monitor_expiry.php?delete_id=<?php echo $row['medicine_id']?>" id="delete" style="color:red;"><i class="fa-solid fa-trash"></i></a> 
                                                </td>
